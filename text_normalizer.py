...
def apply_uzbek_orthoepy_and_dialect(text: str, style: str = "adabiy") -> str:
    ...
    # Texnik va ilmiy qo'shma so'zlarni morfemalarga ajratish (14 harfli ulkan bloklarda harflar yutilmasligi uchun)
    ...
    text = re.sub(r'\baudiokitob', 'avdio kitob', text, flags=re.IGNORECASE)
    text = re.sub(r'\bvideodars', 'video dars', text, flags=re.IGNORECASE)
